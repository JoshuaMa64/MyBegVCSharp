...
namespace Ch11Ex01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var myAnimal in animalArray)
            {
                WriteLine($"New {myAnimal} object added to Array" +
            ...
            {
                WriteLine($"New {myAnimal} object added to ArrayList" +
                          $" collection, Name = {myAnimal.Name}");
            }
            ...
            WriteLine();
            WriteLine("Addition manipulation of ArrayList:");
            ...
            myCow1.Name = "Mary";
            WriteLine($"The animal is called {((Animal)animalArrayList[1]).Name}.");
            ReadKey();
        }
    }
}
